...
@Component
public class CollectionCommentArgumentResolver implements HandlerMethodArgumentResolver {

    private final CollectionCommentRepository collectionCommentRepository;

    public CollectionCommentArgumentResolver(CollectionCommentRepository collectionCommentRepository) {
        this.collectionCommentRepository = collectionCommentRepository;
    }

    @Override
    public boolean supportsParameter(MethodParameter parameter) {
        return parameter.getParameterAnnotation(CurrentCollectionComment.class) != null &&
                CollectionComment.class.isAssignableFrom(parameter.getParameterType());
    }
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
        ...
        if (httpRequest != null) {
            ...
            if (commentIdStr != null) {
                ...
                return collectionCommentRepository.findById(commentId)
                        .orElseThrow(() -> new CustomException(StatusCode.NOT_FOUND, CustomStatusMessage.COLLECTION_COMMENT_NOT_FOUND.getMessage()));
            }
        }
